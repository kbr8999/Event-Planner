...
class Address extends Component{
    ...
    saveAddress = (e) => {
        e.preventDefault();
        let address = {houseNo: this.state.houseNo, streetName: this.state.streetName, landmark: this.state.landmark, city: this.state.city, district: this.state.district, 
